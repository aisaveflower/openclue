...
const Root = Spec.make(typeof OPENCODE_CLI_NAME === "string" ? OPENCODE_CLI_NAME : "openclue", {
  description: "OpenClue autonomous multi-agent coding interface",
  params: {
    ...ServerParams,
    ...PermissionParams,
    directory: Argument.string("directory").pipe(
      Argument.withDescription("Directory to start OpenClue in"),
      Argument.optional,
    ),
  ...
  commands: [
    Spec.make("upgrade", {
      description: "Upgrade OpenClue to the latest or a specific version",
      aliases: ["update"],
      params: {
    ...
    Spec.make("uninstall", {
      description: "Uninstall OpenClue and remove all related files",
      params: {
    ...
    Spec.make("run", {
    description: "Run OpenClue with a message",
      params: {
        ...ServerParams,
