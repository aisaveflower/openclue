...
const TIPS: Tip[] = [
  ...
  "Use {highlight}openclue run{/highlight} for non-interactive scripting",
  "Use {highlight}openclue --continue{/highlight} to resume the last session",
  "Use {highlight}openclue run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}openclue serve{/highlight} for headless API access to OpenCode",
  "Use {highlight}openclue run --attach{/highlight} to connect to a running server",
  "Run {highlight}openclue upgrade{/highlight} to update to the latest version",
  "Run {highlight}openclue auth list{/highlight} to see all configured providers",
  "Run {highlight}openclue agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}openclue github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}openclue debug config{/highlight} to troubleshoot configuration",
